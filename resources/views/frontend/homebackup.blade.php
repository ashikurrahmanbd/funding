    ...
    <section class="carosal-area">
        ...
        <div class="row">
            ...
            <div class="client owl-carousel owl-theme">
                ...
                <div class="item">
                <div class="text">
                    <h3>Need Help for Child Education</h3>
                    <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                    sed do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua. Ut enim <br />
        ...
        <div class="row">
            ...
            <div class="events_single">
                ...
                <span class="event_left"
                    ><i class="material-icons">access_time</i>1:00 pm - 3:00
                    pm</span
                ><span class="event_right"
                    ><i class="material-icons">location_on</i>California
                    Street</span
                >
                </p>
                <div class="clear"></div>
    ...
    <section class="letast_news">
        ...
        <div class="row">
            ...
            <div class="single_news">
                ...
                <div class="texts">
                <p class="date"><a href="#">30 May, 2023</a></p>
                <h3>
            ...
            <div class="single_news">
                ...
                <div class="texts">
                <p class="date"><a href="#">28 May, 2023</a></p>
                <h3>
                    Wood Work Adds Value To <br />
                    Your Property Five
                </h3>
            ...
            <div class="single_news">
                ...
                <div class="texts">
                <p class="date"><a href="#">23 April, 2023</a></p>
                <h3>
                    Wood Work Adds Value To <br />
                    Your Property Five
                </h3>
